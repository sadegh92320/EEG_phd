...
from MAE_pretraining.transformer_variants import TransformerLayerViT, RiemannianCrissCrossTransformer
...
class RiemannTransformerBert2(pl.LightningModule):
    ...
    def __init__(self, config = None, num_channels = 64, 
        ...
        self.encoder = nn.ModuleList([RiemannianCrissCrossTransformer(enc_dim, nhead=8, mlp_ratio=4) for i in range(depth_e)])
