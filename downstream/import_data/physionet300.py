...
dataset_fold = "/Users/sadeghemami/paper_1_code/downstream/data/"
...
for sub in [2,3,4,5,6,7,9,11]:
    ...
    path = "/Volumes/Elements/EEG_data/downstream/files-3/s{:02d}".format(sub)
    for file in os.listdir(path):
        ...
        for i,(d,t) in tqdm.tqdm(enumerate(zip(data, stims))):
            ...
            spath = dataset_fold + f'physionet300_{label}_{i}.npz'
            np.savez(file=spath, x = x, y = y)
